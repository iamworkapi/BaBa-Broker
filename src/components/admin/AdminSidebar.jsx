...
export default function AdminSidebar({ view }) {
  ...
  return (
    <aside className="w-full lg:w-60 xl:w-64 h-full bg-gradient-to-b from-[#ea580c] via-[#f97316] to-[#c2410c] text-white flex flex-col justify-between pl-3 sm:pl-3.5 py-3 pr-0 select-none shrink-0 overflow-hidden font-['Inter',sans-serif] z-20 shadow-2xl">
      <div className="space-y-3.5">
        {/* Brand Header */}
        <div className="px-1.5 pt-0.5 pr-3.5">
