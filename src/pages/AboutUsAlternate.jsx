...
export default function AboutUsAlternate() {
  return (
    <>
    ...
    <section id="about" className="section bg-dark">
        <div className="max-w-7xl mx-auto px-6 lg:px-0 grid lg:grid-cols-2 gap-12 items-center">
            <div className="fade-in">
                ...
                <h2 className="section-title mt-2">About <span className="text-accent">Baba Broker</span></h2>
                <div className="accent-line"></div>
                <p className="text-gray-400 mb-4">
                    Baba Broker is a trusted real estate brokerage firm with over a decade of experience helping clients
                    buy, sell, and invest in properties across the country.
                </p>
                <p className="text-gray-400 mb-6">
                    Our team of certified agents and legal experts ensures every transaction is transparent, smooth, and
                    stress-free — from the first viewing to the final handover.
                </p>
                <ul className="space-y-3 text-sm">
                    <li className="flex items-center gap-3"><i className="fa-solid fa-circle-check text-accent"></i> RERA
                        Registered & Certified Agents</li>
                    <li className="flex items-center gap-3"><i className="fa-solid fa-circle-check text-accent"></i> 700+
                        Successfully Closed Deals</li>
                    <li className="flex items-center gap-3"><i className="fa-solid fa-circle-check text-accent"></i> Transparent
                        Pricing, No Hidden Costs</li>
                    <li className="flex items-center gap-3"><i className="fa-solid fa-circle-check text-accent"></i> End-to-End
                        Legal Assistance</li>
                </ul>
            </div>
            ...
            <div className="fade-in grid grid-cols-2 gap-4">
                <div className="card text-center">
                    <i className="fa-solid fa-house-circle-check text-3xl text-accent mb-3"></i>
                    <p className="text-sm text-gray-400">Properties Sold</p>
                    <p className="stat-number" data-target="700" data-suffix="+">0</p>
                </div>
                <div className="card text-center">
                    <i className="fa-solid fa-users text-3xl text-accent mb-3"></i>
                    <p className="text-sm text-gray-400">Happy Clients</p>
                    <p className="stat-number" data-target="1200" data-suffix="+">0</p>
                </div>
                <div className="card text-center">
                    <i className="fa-solid fa-calendar text-3xl text-accent mb-3"></i>
                    <p className="text-sm text-gray-400">Years Experience</p>
                    <p className="stat-number" data-target="10" data-suffix="+">0</p>
                </div>
                <div className="card text-center">
                    <i className="fa-solid fa-map-location-dot text-3xl text-accent mb-3"></i>
                    <p className="text-sm text-gray-400">Cities Covered</p>
                    <p className="stat-number" data-target="15" data-suffix="+">0</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section className="section bg-dark-2">
        <div className="max-w-7xl mx-auto px-6 lg:px-0 grid lg:grid-cols-2 gap-12 items-center">
            <div className="fade-in">
                <span className="text-accent text-sm font-semibold uppercase tracking-widest">Why Baba Broker</span>
                <h2 className="section-title mt-2">The Smarter Way to <span className="text-accent">Buy & Sell</span></h2>
                <div className="accent-line"></div>
                <div className="space-y-5 mt-2">
                    <div className="flex gap-4">
                        <div className="card-icon flex-shrink-0"><i className="fa-solid fa-shield-halved"></i></div>
                        <div>
                            <h4 className="font-semibold mb-1">100% Verified Listings</h4>
                            <p className="text-gray-400 text-sm">Every property is physically verified and legally checked
                                before listing.</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <div className="card-icon flex-shrink-0"><i className="fa-solid fa-bolt"></i></div>
                        <div>
                            <h4 className="font-semibold mb-1">Fast & Easy Process</h4>
                            <p className="text-gray-400 text-sm">From search to possession — we streamline the entire
                                process for you.</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <div className="card-icon flex-shrink-0"><i className="fa-solid fa-indian-rupee-sign"></i></div>
                        <div>
                            <h4 className="font-semibold mb-1">Best Price Guarantee</h4>
                            <p className="text-gray-400 text-sm">Our market expertise ensures you always get the fairest
                                deal possible.</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="fade-in">
                <div className="card border-primary/30 space-y-4">
                    <h3 className="font-semibold text-lg">Request a Free Consultation</h3>
                    <input type="text" placeholder="Your Name"
                        className="w-full bg-dark border border-white/10 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-primary transition-colors" />
                    <input type="tel" placeholder="Phone Number"
                        className="w-full bg-dark border border-white/10 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-primary transition-colors" />
                    <select
                        className="w-full bg-dark border border-white/10 rounded-lg px-4 py-3 text-sm text-gray-300 focus:outline-none focus:border-primary transition-colors">
                    ...
                    <button className="btn btn-accent w-full justify-center">
                        Book Free Consultation <i className="fa-solid fa-calendar-check"></i>
                    </button>
                </div>
            </div>
        </div>
